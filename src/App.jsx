  ...
  return (
    <>
      <div className="bg-gray-100 overflow-hidden">
        <div className="bg-blue-900 h-5 w-screen"></div>
        <div className="bg-white text-blue-900 p-4 flex items-center justify-between">
          <div className="flex items-center">
            <button className="text-blue p-2 rounded-md hover:bg-gray-100">
              <ArrowLeft className="h-5 w-5" />
            </button>
            <span className="ml-2 font-medium">{invoiceData.invoiceName}</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="mx-5 flex items-center justify-between  p-3  h-10 w-20 border border-gray-400 rounded-md">
              <Undo2 className="text-xl h-5 w-5 text-gray-600 cursor-pointer" />
              <Undo2 className=" text-gray-400 h-5 w-5 rotate-y-180 cursor-pointer" />
            </div>

            <button className="text-black border flex items-center p-2 rounded-md hover:bg-gray-300 transition duration-200">
